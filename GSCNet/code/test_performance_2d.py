...
parser.add_argument('--res_path', type=str, default='./results/ACDC_3/', help='Path to results')
parser.add_argument('--exp', type=str, default='ACDC_11/POST-NoT', help='experiment_name')
parser.add_argument('--model', type=str, default='unet', help='model_name')
parser.add_argument('--num_classes', type=int,  default=4, help='output channel of network')
parser.add_argument('--labeled_num', type=int, default=7, help='labeled data')
parser.add_argument("--flag_check_with_best_stu", default=True, action='store_true', help="")
...
def Inference(FLAGS):
    ...
    # save_model_path = os.path.join(snapshot_path, 'iter_8200_dice_0.8206.pth')
