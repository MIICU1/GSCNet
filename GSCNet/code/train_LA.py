...
if __name__ == "__main__":
    ...
    parser.add_argument('--cfg', type=str, default='config_3d_la_aut.yml',
    ...
    parser.add_argument('--box_size', type=int, default=28, help='patch_size')
    parser.add_argument('--box_size_2', type=int, default=20, help='patch_size')
