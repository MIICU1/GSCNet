...
def var_all_case_LA(model, base_dir, num_classes, patch_size=(112, 112, 80), stride_xy=18, stride_z=4):
    ...
    image_list = [os.path.join(base_dir, "LA", item, "mri_norm2.h5") for item in image_list]
    ...
    for image_path in loader:
        ...
        if np.sum(prediction)==0:
            ...
            # iou = metric.binary.jc(prediction, label)
    ...
    # avg_iou = total_iou / len(image_list)
    # avg_hd95 = total_hd95 / len(image_list)
