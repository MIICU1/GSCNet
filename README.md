...
```bash
# on the ACDC dataset
python train_ACDC.py --root_path /data/ACDC --res_path /results/ACDC

# on the LA dataset
python train_LA.py --root_path /data/LA --res_path /results/LA

# on the Pancreas-CT dataset
python train_Pancreas.py --root_path /data/Pancreas --res_path /results/Pancreas
...
# on the LA and Pancreas-CT datasets
